        ...
        [
            ChatCompletionTextMessage(
                ...
                text=(
                    ...
                    "You are writing a complete, comprehensive, introdution to the unit. "
                    "But, do NOT waste words with fluffy boilerplate or formulaic filler. "
                    "Do not use cheesy formulas like 'Imagine you are' .. "
